 ...
 *
 * @see http://twiki.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/XmlApi
 * @since Class available since release 0.1
 */

namespace AutoInstallFreeSSL\FreeSSLAuto\cPanel;
...
class xmlapi
{
    ...
    public function __construct($host = null, $user = null, $password = null)
    {
        ...
        */
        ...
        //if ( ( $user != null ) && ( strlen( $user ) < 9 ) ) {  // Removing this strlen( $user ) < 9   - because recent version of WHM allow longer username than 9 char
    ...
    public function set_port($port)
    {
        ...
        if ('2086' === $port || '2082' === $port || '80' === $port || '2095' === $port) {
    ...
    {
        if ('json' !== $output && 'xml' !== $output && 'array' !== $output && 'simplexml' !== $output) {
    ...
    {
        if ('hash' !== $auth_type && 'pass' !== $auth_type) {
    ...
    */
    ...
    public function xmlapi_query($function, $vars = [])
    {
        ...
        $response = null;
        if ('curl' === $this->http_client) {
            $response = $this->curl_query($url, $args, $authstr);
        } elseif ('fopen' === $this->http_client) {
        ...
        */
        ...
        if (true === stristr($response, '<html>')) {
            if (true === stristr($response, 'Login Attempt Failed')) {
                error_log('Login Attempt Failed');

                return;
            }
            if (true === stristr($response, 'action="/login/"')) {
        ...
        if (('simplexml' === $this->output) || 'array' === $this->output) {
    ...
    */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/CallingAPIFunctions XML API Call documentation
     * @see http://docs.cpanel.net/twiki/bin/view/DeveloperResources/ApiRef/WebHome API1 & API2 Call documentation
     * @see http://docs.cpanel.net/twiki/bin/view/DeveloperResources/ApiBasics/CallingApiOne API1 Documentation
     */
     ...
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/CallingAPIFunctions XML API Call documentation
     * @see http://docs.cpanel.net/twiki/bin/view/DeveloperResources/ApiRef/WebHome API1 & API2 Call documentation
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ApiTwo Legacy API2 Documentation
     * @see http://docs.cpanel.net/twiki/bin/view/DeveloperResources/ApiBasics/CallingApiTwo API2 Documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ListAvailableCalls XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/CreateAccount XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ChangePassword XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/LimitBandwidth XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ListAccounts XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ModifyAccount XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/EditQuota XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ShowAccountInformation XML API Call documenation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/SuspendAccount XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ListSuspended XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/TerminateAccount
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/UnsuspendAcount XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ChangePackage XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ViewPrivileges XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/DomainUserData
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/SetSiteIp XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/AddDNSZone XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/AddZoneRecord XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/EditZoneRecord XML API Call documentation
     * @see dumpzone()
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/GetZoneRecord XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/DeleteDNSZone XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ListDNSZone XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ListOneZone XML API Call documentation
     * @see editdnsrecord()
     * @see getdnsrecord()
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/LookupIP XML API Call documentation
     */
     ...
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/RemoveZone XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ResetZone XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/AddPackage XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/DeletePackage XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/EditPackage XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ListPackages XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/AddResellerPrivileges XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/CreateResellerACLList XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ListCurrentResellerACLLists XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ListResellerAccounts XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ListResellersAccountsInformation XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/RemoveResellerPrivileges XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/SetResellersACLList XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/TerminateResellerandAccounts XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/SetResellerIps XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/SetResellerLimits XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/SetResellerMainIp XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/SetResellerPkgLimit XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/SuspendReseller XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/UnsuspendReseller XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/AcctCounts XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/SetResellerNameservers XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/DisplayServerHostname XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/DisplaycPanelWHMVersion XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/LoadAvg XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/GetLangList XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/RebootServer XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/AddIPAddress XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/DeleteIPAddress XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/SetHostname XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/SetResolvers XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ShowBw XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/RestartService XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ServiceStatus XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ConfigureService XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/FetchSSL XML API Call documentation
     */
    public function fetchsslinfo($args)
    {
        if ((isset($args['domain'], $args['crtdata'])) || (!isset($args['domain']) && !isset($args['crtdata']))) {
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/GenerateSSL XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/InstallSSL XML API Call documentation
     */
     ...
     * @return mixed
     *
     * @see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/ListSSL XML API Call documentation
     */
    ...
    private function curl_query($url, $postdata, $authstr)
    {
        ...
        if (false === $result) {
            throw new \RuntimeException('curl_exec threw error "'.curl_error($curl).'" for '.$url.'?'.$postdata);
        }
    ...
    private function fopen_query($url, $postdata, $authstr)
    {
        if (!(ini_get('allow_url_fopen'))) {
            throw new \RuntimeException('fopen_query called on system without allow_url_fopen enabled in php.ini');
        }
