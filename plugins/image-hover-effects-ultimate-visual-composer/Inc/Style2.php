        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-4">
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    $this->oxilab_flip_box_admin_color('front-icon-background', $this->style[11], 'rgba', 'Icon Background', 'Set your icon Background Color', 'background-color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-icon-data');
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    $this->oxilab_flip_box_admin_color('front-heading-color', $this->style[13], '', 'Title Color', 'Set your Front Title Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-heading');
                ...
                <div class="oxi-addons-content-div">
                    ...
                    $this->oxilab_flip_box_admin_color('front-info-color', $this->style[29], '', 'Text Color', 'Set your Front Info Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-info');
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-3">
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    $this->oxilab_flip_box_admin_color('backend-title-color', $this->style[31], '', 'Backend Title Color', 'Set your Backend title Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-heading');
