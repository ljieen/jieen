        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-4">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    $this->oxilab_flip_box_admin_number('front-border-margin-top', $this->style[69], '', 'Margin', 'Set your front border Margin.');
                    $this->oxilab_flip_box_admin_number_double('front-padding-top', $this->style[71], 'front-padding-left', $this->style[73], 'Inner Padding', 'Set your front Padding as Top Bottom and Left Right');
                    $this->oxilab_flip_box_admin_color('front-border-color', $this->style[9], '', 'Border Color', 'Set your Border Color', 'border-color', '.oxilab-flip-box-' . $this->oxiid . '');
                    $this->oxilab_flip_box_admin_border('flip-front-border-size', $this->style[75], 'flip-front-border-style', $this->style[77], 'Border Size', 'Set your front border size with different style');
                    ?>
                </div>
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
                    ...
                    <?php
                    $this->oxilab_flip_box_admin_number('front-number-size', $this->style[79], '1', 'Number Size', 'Set your Number Font Size');
                    $this->oxilab_flip_box_admin_color('front-number-color', $this->style[11], '', 'Number Color', 'Set your Number Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-icon-data');
                    $this->oxilab_flip_box_admin_font_family('front-number-family', $this->style[81], 'Font Family', 'Give your Prepared Font from our Google Font List');
                    $this->oxilab_flip_box_admin_font_style('front-number-style', $this->style[83], 'Font Style', 'Set your Number Font Style');
                    $this->oxilab_flip_box_admin_font_weight('front-number-weight', $this->style[85], 'Font Weight', 'Give your Front Number Font Weight');
                    $this->oxilab_flip_box_admin_number_double('front-number-padding-top-bottom', $this->style[87], 'front-number-padding-left-right', $this->style[89], 'Number Padding', 'Set your Number Padding as Top Bottom and Left Right');
                    ?>
                </div>
            </div>
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    $this->oxilab_flip_box_admin_number('front-heading-size', $this->style[159], '1', 'Font Size', 'Set your front Heading Font Size');
                    ...
                    $this->oxilab_flip_box_admin_font_family('front-heading-family', $this->style[161], 'Font Family', 'Give your Prepared Font from our Google Font List');
                    $this->oxilab_flip_box_admin_font_style('front-heding-style', $this->style[163], 'Font Style', 'Set your Heading Font Style');
                    $this->oxilab_flip_box_admin_font_weight('front-heding-weight', $this->style[165], 'Font Weight', 'Give your Front Heading Font Weight');
                    $this->oxilab_flip_box_admin_text_align('front-heding-text-align', $this->style[167], 'Text Align', 'Give your Heading Text Align');
                    $this->oxilab_flip_box_admin_number_double('front-heding-padding-top', $this->style[169], 'front-heding-padding-bottom', $this->style[171], 'Padding Top Bottom', 'Set Your Heading  Padding Top and Bottom');
                    $this->oxilab_flip_box_admin_number_double('front-heding-padding-left', $this->style[173], 'front-heding-padding-right', $this->style[175], 'Padding Left Right', 'Set Your Heading  Padding Left and Right');
                    ?>
                </div>
            </div>
        </div>
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-3">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    $this->oxilab_flip_box_admin_color('backend-background-color', $this->style[15], 'rgba', 'Background Color', 'Set your Backend Background Color', 'background-color', '.oxilab-flip-box-body-' . $this->oxiid . ' .oxilab-flip-box-back');
                    $this->oxilab_flip_box_admin_number('backend-border-margin-top', $this->style[105], '', 'Margin', 'Set your backend border Margin.');
                    $this->oxilab_flip_box_admin_number_double('backend-padding-top', $this->style[101], 'backend-padding-left', $this->style[103], 'Inner Padding', 'Set your Backend Padding as Top Bottom and Left Right');
                    ...
                    $this->oxilab_flip_box_admin_border('flip-backend-border-size', $this->style[149], 'flip-backend-border-style', $this->style[151], 'Border Size', 'Set your backend border size with different style');
                    ?>
                </div>
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    $this->oxilab_flip_box_admin_number('backend-title-border-width', $this->style[155], '1', 'Border Width', 'Set your Backend Title Bottom Border Width');
                    $this->oxilab_flip_box_admin_number('backend-title-border-height', $this->style[157], '1', 'Border Height', 'Set your Backend Title Bottom Border Height');
                    $this->oxilab_flip_box_admin_color('backend-title-bottom-border-color', $this->style[7], '', 'Title Bottom Color', 'Set your Backend Title Bottom Border Color', '', '');
                    ?>
                </div>
            </div>
            <div class="oxi-addons-col-6">
