...
class Style17 extends Admin_Render {
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-5">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    $this->oxilab_flip_box_admin_number('flip-border-radius', $this->style[141], '1', 'Border Radius', 'Set your flip Border Radius');
                    ?>    
                </div> 
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-4">                                         
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    $this->oxilab_flip_box_admin_number_double('front-padding-top', $this->style[69], 'front-padding-left', $this->style[71], 'Padding', 'Set your Front Padding as Top Bottom and Left Right');
                    $this->oxilab_flip_box_admin_border('flip-col-border-size', $this->style[101], 'flip-col-border-style', $this->style[103], 'Border Size', 'Set your front border size with different style');
                    $this->oxilab_flip_box_admin_color('front-border-color', $this->style[21], '', 'Border Color', 'Set your Border Color', 'border-color', '.oxilab-flip-box-' . $this->oxiid . '');
                    ?>    
                </div>
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
                    ...
                    <?php
                    $this->oxilab_flip_box_admin_number('front-icon-size', $this->style[73], '1', 'Icon Size', 'Set your Icon Font Size');
                    ...
                    $this->oxilab_flip_box_admin_number_double('front-icon-padding-top-bottom', $this->style[77], 'front-icon-padding-left-right', $this->style[79], 'Icon Padding', 'Set your Icon Padding as Top Bottom and Left Right');
                    ?> 
                </div>
            </div>
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    $this->oxilab_flip_box_admin_color('front-heading-color', $this->style[11], '', 'Title Color', 'Set your Front Heading Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-heading');
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-3">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    $this->oxilab_flip_box_admin_number_double('backend-padding-top', $this->style[119], 'backend-padding-left', $this->style[121], 'Padding', 'Set your Backend Padding as Top Bottom and Left Right');
                    $this->oxilab_flip_box_admin_border('flip-backend-border-size', $this->style[105], 'flip-backend-border-style', $this->style[107], 'Border Size', 'Set your backend border size with different style');
                    $this->oxilab_flip_box_admin_color('backend-border-color', $this->style[23], '', 'Border Color', 'Set your Border Color', 'border-color', '.oxilab-flip-box-back-' . $this->oxiid . '');
                    ?>    
                </div> 
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
                    ...
                    <?php
                    $this->oxilab_flip_box_admin_number('backend-info-size', $this->style[123], '1', 'Font Size', 'Set your Backend Info Font Size');
                    $this->oxilab_flip_box_admin_color('backend-info-color', $this->style[15], '', 'Text Color', 'Set your Backend Info Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-info');
                    $this->oxilab_flip_box_admin_font_family('backend-info-family', $this->style[125], 'Font Family', 'Give your Prepared Font from our Google Font List');
                    $this->oxilab_flip_box_admin_font_style('backend-info-style', $this->style[127], 'Font Style', 'Set your Backend Info Font Style');
                    $this->oxilab_flip_box_admin_font_weight('backend-info-weight', $this->style[129], 'Font Weight', 'Give your Backend Info Font Weight');
                    $this->oxilab_flip_box_admin_text_align('backend-info-text-align', $this->style[131], 'Text Align', 'Give your Backend Info Text Align');
                    $this->oxilab_flip_box_admin_number_double('backend-info-padding-top', $this->style[133], 'backend-info-padding-bottom', $this->style[135], 'Padding Top Bottom', 'Set Your Backend Info  Padding Top and Bottom');
                    $this->oxilab_flip_box_admin_number_double('backend-info-padding-left', $this->style[137], 'backend-info-padding-right', $this->style[139], 'Padding Left Right', 'Set Your Backend Info  Padding Left and Right');
                    ?> 
                </div> 
            </div>
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    $this->oxilab_flip_box_admin_number('backend-button-size', $this->style[143], '1', 'Font Size', 'Set your Backend Button Font Size');
                    $this->oxilab_flip_box_admin_color('backend-button-color', $this->style[17], '', 'Button Color', 'Set your Backend Button Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-button-data');
                    $this->oxilab_flip_box_admin_color('backend-button-hover-color', $this->style[19], '', 'Button Hover', 'Set your Backend Button Hover Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-button-data:hover');
                    $this->oxilab_flip_box_admin_font_family('backend-button-family', $this->style[145], 'Font Family', 'Give your Prepared Font from our Google Font List');
                    $this->oxilab_flip_box_admin_font_style('backend-button-style', $this->style[147], 'Font Style', 'Set your Backend Button Font Style');
                    $this->oxilab_flip_box_admin_font_weight('backend-button-weight', $this->style[149], 'Font Weight', 'Give your Backend Button Font Weight');
                    $this->oxilab_flip_box_admin_number_double('backend-button-info-padding-top', $this->style[151], 'backend-button-info-padding-left', $this->style[153], 'Padding', 'Set Your Backend Button Padding Top Bottom and left Right');
                    $this->oxilab_flip_box_admin_number('backend-button-border-radius', $this->style[155], '1', 'Border Radius', 'Set your Backend Button Border Radius');
                    $this->oxilab_flip_box_admin_text_align('backend-button-text-align', $this->style[157], 'Text Align', 'Give your Backend Button Text Align');
                    $this->oxilab_flip_box_admin_number_double('backend-info-margin-top', $this->style[159], 'backend-info-margin-bottom', $this->style[161], 'Margin Top Bottom', 'Set Your Backend Info Margin Top and Bottom');
                    $this->oxilab_flip_box_admin_number_double('backend-info-margin-left', $this->style[163], 'backend-info-margin-right', $this->style[165], 'Margin Left Right', 'Set Your Backend Info Margin Left and Right');
                    ?> 
                </div> 
            </div>
        </div>
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-2">
            <div class="col-xs-12 p-2">
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo esc_html($this->style[167]); ?></textarea>
    ...
    public function modal_form_data() {
        ...
        <div class="modal-body row">
            ...
            $this->oxilab_flip_box_admin_input_text('flip-box-backend-link', $this->child_editable[9], 'Link', 'Add your desire link or url unless make it blank');
            $this->image_upload('flip-box-image-upload-url-02', $this->child_editable[11], 'Backend Background Image', 'Add or Modify Your Backend Background Image. Unless make it blank.');
            ?>                                            
        </div>
        <?php
    }
