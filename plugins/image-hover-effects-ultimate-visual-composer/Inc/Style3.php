...
class Style3 extends Admin_Render {
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-4">
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    $this->oxilab_flip_box_admin_number('front-icon-width', $this->style[75], '1', 'Icon width', 'Set your Icon Width and Height Size.');
                    ...
                    $this->oxilab_flip_box_admin_text_align('front-icon-text-align', $this->style[81], 'Text Align', 'Give your Icon Text Align');
                    ?>
                </div>
            </div>
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    $this->oxilab_flip_box_admin_number('front-info-size', $this->style[101], '1', 'Font Size', 'Set your front Info Font Size');
                    $this->oxilab_flip_box_admin_color('front-info-color', $this->style[17], '', 'Text Color', 'Set your Front Heading Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-info');
                    $this->oxilab_flip_box_admin_font_family('front-info-family', $this->style[103], 'Font Family', 'Give your Prepared Font from our Google Font List');
                    $this->oxilab_flip_box_admin_font_style('front-info-style', $this->style[105], 'Font Style', 'Set your Info Font Style');
                    $this->oxilab_flip_box_admin_font_weight('front-info-weight', $this->style[107], 'Font Weight', 'Give your Front Info Font Weight');
                    $this->oxilab_flip_box_admin_text_align('front-info-text-align', $this->style[109], 'Text Align', 'Give your Info Text Align');
                    $this->oxilab_flip_box_admin_number_double('front-info-padding-top', $this->style[111], 'front-info-padding-bottom', $this->style[113], 'Padding Top Bottom', 'Set Your Info  Padding Top and Bottom');
                    $this->oxilab_flip_box_admin_number_double('front-info-padding-left', $this->style[115], 'front-info-padding-right', $this->style[117], 'Padding Left Right', 'Set Your Info  Padding Left and Right');
                    ?>
                </div>
            </div>
        </div>
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-2">
            <div class="col-xs-12 p-2">
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo esc_html($this->style[143]); ?></textarea>
    ...
    public function modal_form_data() {
        ...
        <div class="modal-body row">
            ...
            $this->oxilab_flip_box_admin_input_text_area('flip-box-font-desc', $this->child_editable[13], 'Font Info:', 'Add font Info text unless make it blank.');
