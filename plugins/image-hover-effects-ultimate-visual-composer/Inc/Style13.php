            ...
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                     ...
                     $this->oxilab_flip_box_admin_color('front-icon-background-color', $this->style[11], '', 'Icon Background Color', 'Set your Icon Background Color', 'background-color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-icon-data [class^=\'fa\']');
                     $this->oxilab_flip_box_admin_color('front-icon-border-color', $this->style[7], '', 'Border Color', 'Set your Icon Border Color', 'border-color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-icon-data');
            ...
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                     ...
                     $this->oxilab_flip_box_admin_color('front-info-color', $this->style[29], '', 'Text Color', 'Set your Front Heading Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-info');
