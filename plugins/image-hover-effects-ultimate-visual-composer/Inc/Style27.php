        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-4">
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    $this->oxilab_flip_box_admin_number('front-title-border-width', $this->style[75], '1', 'Border Width', 'Set your Front Title Bottom Border Width');
                    $this->oxilab_flip_box_admin_number('front-title-border-height', $this->style[77], '1', 'Border Height', 'Set your Front Title Bottom Border Height');
                    $this->oxilab_flip_box_admin_color('front-title-bottom-border-color', $this->style[9], '', 'Title Bottom Color', 'Set your Front Title Bottom Border Color', 'background-color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-heading .oxilab-span');
                    ?> 
                </div>
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
                    ...
                    <?php
                    $this->oxilab_flip_box_admin_number('front-info-size', $this->style[79], '1', 'Font Size', 'Set your front Info Font Size');
                    ...
                    $this->oxilab_flip_box_admin_font_family('front-info-family', $this->style[81], 'Font Family', 'Give your Prepared Font from our Google Font List');
                    $this->oxilab_flip_box_admin_font_style('front-info-style', $this->style[83], 'Font Style', 'Set your Info Font Style');
                    $this->oxilab_flip_box_admin_font_weight('front-info-weight', $this->style[85], 'Font Weight', 'Give your Front Info Font Weight');
                    $this->oxilab_flip_box_admin_text_align('front-info-text-align', $this->style[87], 'Text Align', 'Give your Info Text Align');
                    $this->oxilab_flip_box_admin_number_double('front-info-padding-top', $this->style[89], 'front-info-padding-bottom', $this->style[91], 'Padding Top Bottom', 'Set Your Info  Padding Top and Bottom');
                    $this->oxilab_flip_box_admin_number_double('front-info-padding-left', $this->style[93], 'front-info-padding-right', $this->style[95], 'Padding Left Right', 'Set Your Info  Padding Left and Right');
                    ?> 
                </div> 
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-3">
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    $this->oxilab_flip_box_admin_color('backend-title-bottom-border-color', $this->style[7], '', 'Title Bottom Color', 'Set your Backend Title Bottom Border Color', 'background-color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-heading .oxilab-span');
                    ?>    
                </div> 
            </div>
            <div class="oxi-addons-col-6">
