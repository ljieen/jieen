        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-4">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    $this->oxilab_flip_box_admin_color('front-top-border-color', $this->style[11], '', 'Top Border Color', 'Set your Front Top Border Color', 'background-color', '.oxilab-flip-box-' . $this->oxiid . ' .oxilab-span');
                    $this->oxilab_flip_box_admin_number('front-top-border-height', $this->style[75], '1', 'Top Border Height', 'Set your Top Border Height.');
                    ?>    
                </div> 
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-2">
            <div class="col-xs-12 p-2">
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo esc_html($this->style[163]); ?></textarea>
