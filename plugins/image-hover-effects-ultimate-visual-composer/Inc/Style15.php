        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-4">
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    $this->oxilab_flip_box_admin_color('front-heading-color', $this->style[9], '', 'Title Color', 'Set your Front Heading Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-heading');
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    $this->oxilab_flip_box_admin_number('front-title-border-width', $this->style[157], '1', 'Border Width', 'Set your Front Title Bottom Border Width');
                    $this->oxilab_flip_box_admin_number('front-title-border-height', $this->style[159], '1', 'Border Height', 'Set your Front Title Bottom Border Height');
                    $this->oxilab_flip_box_admin_color('front-title-bottom-border-color', $this->style[17], '', 'Title Bottom Color', 'Set your Front Title Bottom Border Color', 'background-color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-heading .oxilab-span');
                    ?>
                </div>
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
                    ...
                    $this->oxilab_flip_box_admin_color('front-info-color', $this->style[11], '', 'Text Color', 'Set your Front Heading Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-info');
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-3">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    $this->oxilab_flip_box_admin_color('backend-border-color', $this->style[15], '', 'Border Color', 'Set your Border Color', 'border-color', '.oxilab-flip-box-back-' . $this->oxiid . '');
                    ?>
                </div>
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
                    ...
                    <?php
                    $this->oxilab_flip_box_admin_number('backend-icon-size', $this->style[105], '1', 'Icon Size', 'Set your Icon Font Size');
                    $this->oxilab_flip_box_admin_color('backend-icon-color', $this->style[27], '', 'Icon Color', 'Set your Icon Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-icon-data [class^=\'fa\']');
                    $this->oxilab_flip_box_admin_number('backend-icon-width', $this->style[107], '1', 'Icon width', 'Set your Icon Width and Height Size.');
                    $this->oxilab_flip_box_admin_number_double('backend-icon-padding-top-bottom', $this->style[109], 'backend-icon-padding-left-right', $this->style[111], 'Icon Padding', 'Set your Icon Padding as Top Bottom and Left Right');
                    ?>
                </div>
            </div>
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    $this->oxilab_flip_box_admin_number('backend-button-size', $this->style[161], '1', 'Font Size', 'Set your Backend Button Font Size');
                    $this->oxilab_flip_box_admin_color('backend-button-color', $this->style[19], '', 'Button Color', 'Set your Backend Button Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-button-data');
                    $this->oxilab_flip_box_admin_color('backend-button-background', $this->style[21], 'rgba', 'Buton Background', 'Set your Backend Button Background Color', 'background-color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-button-data');
                    $this->oxilab_flip_box_admin_color('backend-button-hover-color', $this->style[23], '', 'Button Hover', 'Set your Backend Button Hover Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-button-data:hover');
                    $this->oxilab_flip_box_admin_color('backend-button-hover-background', $this->style[25], 'rgba', 'Button Hover Background', 'Set your Backend Button Hover Background Color', 'background-color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-button-data:hover');
                    $this->oxilab_flip_box_admin_font_family('backend-button-family', $this->style[163], 'Font Family', 'Give your Prepared Font from our Google Font List');
                    $this->oxilab_flip_box_admin_font_style('backend-button-style', $this->style[165], 'Font Style', 'Set your Backend Button Font Style');
                    $this->oxilab_flip_box_admin_font_weight('backend-button-weight', $this->style[167], 'Font Weight', 'Give your Backend Button Font Weight');
                    $this->oxilab_flip_box_admin_number_double('backend-button-info-padding-top', $this->style[169], 'backend-button-info-padding-left', $this->style[171], 'Padding', 'Set Your Backend Button Padding Top Bottom and left Right');
                    $this->oxilab_flip_box_admin_number('backend-button-border-radius', $this->style[173], '1', 'Border Radius', 'Set your Backend Button Border Radius');
                    $this->oxilab_flip_box_admin_text_align('backend-button-text-align', $this->style[175], 'Text Align', 'Give your Backend Button Text Align');
                    $this->oxilab_flip_box_admin_number_double('backend-info-margin-top', $this->style[177], 'backend-info-margin-bottom', $this->style[179], 'Margin Top Bottom', 'Set Your Backend Info Margin Top and Bottom');
                    $this->oxilab_flip_box_admin_number_double('backend-info-margin-left', $this->style[181], 'backend-info-margin-right', $this->style[183], 'Margin Left Right', 'Set Your Backend Info Margin Left and Right');
                    ?>
                </div>
            </div>
        </div>
