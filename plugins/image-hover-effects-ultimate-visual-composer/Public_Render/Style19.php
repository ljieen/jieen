...
background-size: 100% 100%;
            ...
            $this->inline_css .= '.oxilab-flip-box-padding-' . $styleid . '{
                ...
                .oxilab-flip-box-back-' . $styleid . ' .oxilab-button{
                    display: block;
                    position: absolute;
                    right: 0;
                    bottom: 0;
                ...
                .oxilab-flip-box-back-' . $styleid . ' .oxilab-button .oxi-icons{
                    display: inline-block;
                    color: ' . $styledata[9] . ';
                    font-size: ' . $styledata[125] . 'px;
                    padding: ' . $styledata[133] . 'px ' . $styledata[135] . 'px;
                }
                .oxilab-flip-box-back-' . $styleid . ' .oxilab-button .oxi-icons:hover{
                    color:  ' . $styledata[11] . ';
                }
                ' . $styledata[199] . '';
            ?>
